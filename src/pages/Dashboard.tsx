...
export default function Dashboard() {
    const [assets, setAssets] = useState<Asset[]>([
        { id: 1, symbol: 'AAPL', shares: 100, purchasePrice: 150, currentPrice: 175, boughtOn: '' },
        { id: 2, symbol: 'TSLA', shares: 500, purchasePrice: 240, currentPrice: 240, boughtOn: '' }, 
        { id: 3, symbol: 'VOO', shares: 20, purchasePrice: 350, currentPrice: 410, boughtOn: '' },
    ]);
                ...
                <header className="mb-8">
                    <div className="flex justify-between items-center">
                        ...
                        <button 
                            ...
                            className="bg-emerald-800 text-white px-4 py-2 rounded-md shrink-0 ml-4 cursor-pointer hover:bg-emerald-900 transition-colors"
                        >
                            Add Asset
                        </button>
                    </div>
